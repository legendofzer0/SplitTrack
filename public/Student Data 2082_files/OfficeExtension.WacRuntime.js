...
(function (OfficeExtension) {
    ...
    (function (WacRuntime) {
        var RichApi = (function () {
            ...
            RichApi.initializeCopilotUnsafeApiList = function (copilotUnsafeApiList) {
                if (!RichApi.s_copilotUnsafeApiList &&
                    copilotUnsafeApiList &&
                    copilotUnsafeApiList.length > 0) {
                    RichApi.s_copilotUnsafeApiList = copilotUnsafeApiList.split(";").map(function (api) { return api.trim(); });
                }
            };
            RichApi.isCopilotUnsafeApi = function (apiName) {
                if (RichApi.s_copilotUnsafeApiList) {
                    return RichApi.s_copilotUnsafeApiList.indexOf(apiName) >= 0;
                }
                return false;
            };
            ...
            RichApi.s_copilotUnsafeApiList = null;
            return RichApi;
        }());
    ...
    (function (WacRuntime) {
        var UtilityInternal = (function () {
            ...
            UtilityInternal.checkSafeTypeFlags = function (requestContext, typeFlags, apiName) {
                ...
                if ((requestContext.request.requestFlags & WacRuntime.RichApiRequestFlags.OnlyAllowCopilotSafeApi) !== 0 && ((typeFlags & WacRuntime.TypeFlags.copilotSafe) === 0 || WacRuntime.RichApi.isCopilotUnsafeApi(apiName))) {
                    throw UtilityInternal.createAccessDeniedException(apiName);
                }
            };
            ...
            UtilityInternal.checkSafeApiFlags = function (requestContext, apiFlags, name, apiName) {
                ...
                if ((requestContext.request.requestFlags & WacRuntime.RichApiRequestFlags.OnlyAllowCopilotSafeApi) !== 0 &&
                    ((apiFlags & WacRuntime.ApiFlags.copilotSafe) === 0 || WacRuntime.RichApi.isCopilotUnsafeApi(apiName))) {
                    if (!UtilityInternal.isSpecialApiNotRequirePermissionCheck(name)) {
                        throw UtilityInternal.createAccessDeniedException(apiName);
                    }
                }
